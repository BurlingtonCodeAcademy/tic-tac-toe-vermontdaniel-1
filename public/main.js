...
//// Computer AI (working on this one) -------------------------------------------------------------------------------------------------------------------
function dumbComputerAi() {
  ...
  let guess = randomInteger(0, 8);
  console.log(guess);
  console.log(cellArray[guess]);
  if (cellArray[guess].textContent === '') {
    cellArray[guess].textContent = 'O';
